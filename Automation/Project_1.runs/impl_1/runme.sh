...
HD_PWD='/home/nishantk24/give-environment-name/scripting-and-automation/Automation/Project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_knowles_bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_knowles_bit.tcl -notrace
