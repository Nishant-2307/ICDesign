...
HD_PWD='/home/nishantk24/give-environment-name/scripting-and-automation/Automation/Project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_knowles_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_knowles_bit.tcl
